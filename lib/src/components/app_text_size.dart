...
TextStyle titleTextStyle = TextStyle(fontSize: 64, wordSpacing: 3.0);
TextStyle subTitleTextStyle = TextStyle(fontSize: 36.0, color: Colors.black87, wordSpacing: 3.0);
TextStyle contentTextStyle = TextStyle(fontSize: 24, color: Colors.black54, wordSpacing: 3);
